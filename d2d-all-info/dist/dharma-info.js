...
const dharmaLists = {
  "Eightfold Path": {
    ...
    parts: {
      ...
      "morality group": ["right speech", "right action", "right livelihood"],
      "meditation group": ["right effort", "right mindfulness", "right concentration"]
    }
  },
  "Five Precepts": {
    definition: "Standards for lay Buddhists to live an ethical life in pursuit of enlightenment.",
    parts: ["no killing", "no stealing", "no sexual misconduct", "no lying", "no taking intoxicants"]
  },
  "Ten Wholesome Conducts": {
    definition: "These levels of action are grouped into those of the body, speech, and mind.",
    parts: {
      body: ["no killing", "no stealing", "no sexual misconduct"],
      speech: ["no lying", "no frivolous speech", "no harsh words", "no idle chatter"],
      mind: ["no craving or lusting", "no anger", "no wrong views"]
    }
  },
  "Six Virtues": {
    definition: "These are ideal qualities of Mahayana Buddhists (Theravada has 10 qualities).",
    pali: ["paramita"],
    parts: {
  ...
  "Five Aggregates": {
    definition: "Temporary conditioned phenomena that create the illusion of self.",
    pali: ["skandha"],
    parts: {
  ...
  "Four Attachments": {
    definition: "These are the attachments which lead to unsatisfactoriness.",
    pali: ["upadana"],
    parts: {
      pali: ["attavadupadana", "ditthupadana", "silabbatupadana", "kamupadana"]
    }
  },
  "Six Internal and External Spheres of Sense": {
    definition: "Experiences, either pleasant, unpleasant or neutral, comes through these portals.",
    parts: {
      bodyparts: {
        eye: "seeing",
        ear: "hearing",
  ...
  "Six Realms of Existence": {
    definition: "Analogies for conditioned experiences within samsara where beings are reborn.",
    parts: {
  ...
  "Five Hinderances": {
    ...
    parts: {
      pali: ["kamacchanda", "vyapada", "thina-middha", "uddhacca-kukkucca", "vicikiccha"]
    }
  },
  "Seven Constituents of Awakening": {
    definition: "NEEDS DEFINITION",
    parts: {
      pali: ["sati", "dhamma vicaya", "viriya", "piti", "passaddhi", "samadhi", "uppekha"]
    }
  },
  "Four Meditative Absorptions": {
    definition: "Evolving states of meditation.",
    pali: ["jhana"],
    parts: ["aloof from sense desires and unwholesome thoughts, resulting in applied and sustained thought, joy and bliss.", "replacing applied and sustained thought with single-pointedness of mind, tranquility, joy and bliss.", "replacing mental joy with equanimity, mindfulness and bodily bliss.", "beyond joy and bliss, suffering, and sorrow: total equanimity and mindfulness."],
    isOrdered: true,
    suttas: [{
      title: "Jhana Sutta",
...
const fourNobleTruths = {
  ...
  parts: [{
    ...
    pali: ["dukkha"],
    concatenate: true,
    parts: ["birth", "aging", "death", "bodily pain", "mental pain", "despair", "unfulfilled desires", makeListDisplay("Five Aggregates")]
  }, {
    ...
    definition: "The truth of the path leading to the cessation of suffering.",
    parts: ["This Noble Eightfold Path"]
  }]
};
const specificMentalObjects = {
  name: "Specific Mental Objects",
  parts: [makeListDisplay("Five Hinderances"), makeListDisplay("Five Aggregates"), makeListDisplay("Six Internal and External Spheres of Sense"), makeListDisplay("Seven Constituents of Awakening"), {
    name: "Four Noble Truths",
    parts: [cnSetter => /*#__PURE__*/React.createElement("div", {
      className: "linked",
      onClick: () => cnSetter(1),
      key: "right-understanding-link"
    }, "see Right Understanding")]
  }]
};
const thePath = [{
  pali: ["prajna"],
  ...
  parts: [{
    ...
    pali: ["ajiva"],
    parts: ["no trading in weapons", "no trading in human trafficking", "no trading in meat", "no trading in intoxicants", "no trading in poison"],
    suttas: [{
      title: "Vanijja Sutta",
      section: "Anguttara Nikaya",
      verse: 5.177,
  ...
  parts: [{
    pali: ["vayama"],
    parts: ["abandon arisen unwholesome states of mind", "prevent unarisen unwholesome states of mind", "arouse unarisen wholesome states of mind", "maintain arisen wholesome states of mind"],
    title: "sammappadhana"
  }, {
    pali: ["sati"],
    parts: [{
